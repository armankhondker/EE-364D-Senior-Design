	...
	render() {
		return (
            ...
            <Form.Group controlId="academicReqExp">
                <Form.Check label="To fulfill an academic requirement (i.e. capstone, thesis, dissertation"/>
            </Form.Group>
            ...
            <Form.Group controlId="intlStudent">
                <Form.Label>To comply with University rules and regulations, are you an international student?</Form.Label>
            ...
            <Form.Group controlId="CoursesTaken1">
                ...
                <Form.Check label="Program Evaluation for Nonprofit, Public, & Social Impact Initiatives (PA 397C-59534)"/>
            ...
            <Form.Group controlId="coursesTaken2">
                ...
                <Form.Check label="Linked Open Data & Computational Social Science Methods (PA 397C-59530)"/>
